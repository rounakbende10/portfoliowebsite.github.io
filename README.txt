...
𝗗𝗮𝘁𝗮 𝗦𝗰𝗶𝗲𝗻𝗰𝗲 𝗮𝗻𝗱 𝗠𝗟: Pandas, NumPy, Keras, PySpark, TensorFlow, Scikit-Learn
𝗧𝗼𝗼𝗹𝘀 𝗮𝗻𝗱 𝗧𝗲𝗰𝗵𝗻𝗼𝗹𝗼𝗴𝗶𝗲𝘀: Tableau, GitHub, Docker, AWS (EC2, RDS, S3, Lambda, Redshift, Athena, Glue)
𝗖𝗼𝗻𝗰𝗲𝗽𝘁𝘀: Scrum, A/B testing, hypothesis testing, Machine Learning, Deep Learning
𝗦𝗼𝗳𝘁 𝗦𝗸𝗶𝗹𝗹𝘀: Team player, Bias for action, Deliver results
𝗜𝗻𝘁𝗲𝗿𝗲𝘀𝘁𝘀: Travelling, Nutrition, Food, Fitness, Self-Improvement
